...
public class StringEx {
	...
	public static void main(String[] args) {		
		...
		System.out.println("문자열을 3번인덱스부터 찾은위치: " + str.indexOf("l", 3));
		System.out.println("문자열을 뒤에서 부터 찾은 위치: " + str.lastIndexOf("l"));
		System.out.println("찾는 문자가 없으면: "+str.indexOf("야")); //찾는 문자가 없어서 -1 출력
		...
		System.out.println("홍길동".compareTo("홍길동")); //0=> 같은 문자열

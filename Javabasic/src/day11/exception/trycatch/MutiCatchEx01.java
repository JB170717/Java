...
//		} catch (ArrayIndexOutOfBoundsException e) { //예외를 처리할클래스
//			System.out.println("실행 매개값을 반드시 2개 전달해주세요");
		} catch(NumberFormatException e) {
			System.out.println("실행 매개값을 반드시 숫자로 전달해주세요");
		} catch(Exception e) { //예외들의 가장큰 부모 클래스이기 때문에, 모든 예외 처리가 가능함.
